...
<body>
	...
	<div class="map_wrap" >
		<div id="map"
			style="width: 600px; height: 500px; position: relative; overflow: hidden;"></div>
		<ul id="category">
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=f920b0806de4f043231ba2b8768f333e&libraries=services"></script>
	<script>
		...
		mapOption = {
			center : new kakao.maps.LatLng(37.55432673030333,126.93571109768847), // 지도의 중심좌표
			level : 3
		// 지도의 확대 레벨
		};
