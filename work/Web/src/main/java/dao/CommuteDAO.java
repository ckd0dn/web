...
public class CommuteDAO {
	...
	//전체 게시물 조회
		public List<CommuteVO> selectList(){
			...
			List<CommuteVO> list = sqlSession.selectList("commute.commute_select");
			return list;
		}

		//초기값
		public int insert_init(CommuteVO vo) {		
			int res = sqlSession.insert("commute.commute_insert_init", vo);
			return res;
		}
