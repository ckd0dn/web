                                ...
                                <div class="postWrite">
                                    ...
                                    <dl>
                                        ...
                                        <dd class="sel_2part">
                                            ...
                                            <input type="button" class="stb-box-btn email_btn" value="인증코드 발송" onclick="id_email_check(this.form);">
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt><label>이메일 인증</label></dt>
                                        <dd class="sel_2part">
                                            <input type="text" title="인증코드 입력" name="id_code" id="id_code">
                                ...
                                <div class="postWrite">
                                    ...
                                    <dl>
                                        ...
                                        <dd class="sel_2part">
                                            ...
                                            <input type="button" class="stb-box-btn email_btn" value="인증코드 발송" onclick="pwd_email_check(this.form);">
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt><label>이메일 인증</label></dt>
                                        <dd class="sel_2part">
                                            <input type="text" title="인증코드 입력" name="pwd_code" id="pwd_code">
