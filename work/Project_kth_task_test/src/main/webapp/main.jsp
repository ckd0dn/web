  ...
  <table class="postTable"> 
					<colgroup>
						...
						<thead>
							<tr>
				                <th scope="col">
								    <div class="_chkBox table-chkBox">
										<span class="chk-area">
									...
									<tbody>
										<tr>
											<td>
								            	<div class="_chkBox table-chkBox">
													<span class="chk-area">
														<input type="checkbox" name="chk-cell">
														<label><span></span></label>
													</span>
												</div>
											</td>
											<td>${ task.task }</td>
											<td><img src="../img/btn_delete.gif" onclick="task_del('${task.task_idx}');"></td>
										</tr>
									</tbody>
									</c:forEach>
				...
				<form>
                	<div class="in-task">
								<input type="text" title="task입력" class="task-input" name="task">
